...
var objstr3:[String] = ["https://www.themealdb.com/images/media/meals/qxytrx1511304021.jpg","https://www.themealdb.com/images/media/meals/1529444113.jpg"]
...
class CollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //cell.img = post2[indexPath.row].userimg
        cell.displayContent(img: saved[indexPath.row].strMealThumb, inst: saved[indexPath.row].strInstructions, name: saved[indexPath.row].strMeal)
        //cell.("")
        return cell
    }
